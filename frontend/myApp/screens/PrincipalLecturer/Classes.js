      ...
      >
        ...
        <View style={styles.basicInfo}>
          ...
          <View style={styles.basicRow}>
            ...
            <Text style={[styles.basicText, { color: colors.text + "70" }]}>{item.totalStudents || 0} students</Text>
          </View>
        </View>
        ...
        {isExpanded && (
          <View style={[styles.expandedDetails, { borderTopColor: colors.border }]}>
            ...
            <View style={styles.detailSection}>
              <Text style={[styles.detailLabel, { color: colors.text + "60" }]}>Schedule</Text>
              <Text style={[styles.detailValue, { color: colors.text }]}>{item.day} at {item.time}</Text>
            </View>
          </View>
        )}
      </TouchableOpacity>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyContainer}>
              ...
              <Text style={[styles.emptyTitle, { color: colors.text + "60" }]}>No Classes Found</Text>
